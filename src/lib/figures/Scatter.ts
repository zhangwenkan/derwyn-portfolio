...
const POINT_TEXTURE_SRC = typeof pointImg === "string" ? pointImg : pointImg.src;
const SCATTER_TEXTURE_SRC =
  typeof scatterImg === "string" ? scatterImg : scatterImg.src;
const POINT_TEXTURE = textureLoader.load(POINT_TEXTURE_SRC);
const SCATTER_TEXTURE = textureLoader.load(SCATTER_TEXTURE_SRC);
